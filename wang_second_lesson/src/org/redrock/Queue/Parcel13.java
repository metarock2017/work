...
public class Parcel13 {
    public static void main(String[] args) {
        ...
        PriorityQueue<Pet>  priorityQueue1 = new PriorityQueue<>(4);
        Pet aa = new Pet("aa");
        Pet dog = new Pet("dog");
        Pet bb = new Pet("bb");
        Pet cat = new Pet("cat");
        priorityQueue1.add(aa);
        priorityQueue1.add(dog);
        priorityQueue1.add(bb);
        priorityQueue1.add(cat);
        Pet.comparator(priorityQueue1);
    }
}
...
//
//    //@Override
//    public void compare(PriorityQueue<Pet> pets) {
//        while (!pets.isEmpty()) {
//            for (Pet pet : pets) {
//                if (pet.equals(new Pet("cat"))) {
